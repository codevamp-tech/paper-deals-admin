            ...
            >
              ...
              Change Password
                    ...
                    <>
                        ...
                        {/* Enquiry - shown in both B2B and B2C */}
                        <DropdownMenu
                            title="Enquiry"
                            icon={HelpCircle}
                            isOpen={inquiryOpen}
                        ...
                        {mode === "b2b" && (
                            <>
                                ...
                                <DropdownMenu
                                    ...
                                    links={[
                                        { name: "Sellers", href: "/admin/seller-page/seller", icon: UserCircle },
                                ...
                                <Link
                                    ...
                                    className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${isActive("/admin/consultant-category")
                                        ? "bg-blue-600 text-white"
                                        : "text-gray-300 hover:bg-gray-800 hover:text-white"
                                        }`}
                                >
