...
export default function AdminSubscriptions() {
  ...
  const StatusBadge = ({ status }: { status: string | number }) => {
    ...
    return (
      <span
        className={`text-white px-2 py-1 rounded ${colors[normalizedStatus] || "bg-gray-500"
          }`}
      >
  ...
  return (
    <div className="p-8 space-y-12">
      ...
      {/* Detailed Subscriptions */}
      <div>
        <h2 className="text-xl font-bold mb-4">Subscriptions Details</h2>
        <table className="table-auto w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-100">
              <th className="border px-4 py-2">ID</th>
      ...
      <div>
        <h2 className="text-xl font-bold mb-4">Chat Payment History</h2>
        <table className="table-auto w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-100">
              <th className="border px-4 py-2">ID</th>
